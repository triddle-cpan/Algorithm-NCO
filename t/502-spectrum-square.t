...
use Algorithm::NCO;
use Algorithm::NCO::Test qw(is_tolerance is_error create_real_signal fft_real read_refdata get_square_harmonic_amplitude);
use Data::Dumper;
use Math::Complex;
...
sub test_real_spectrum {
    ...
    for(my $freq = 0; $freq < @spectrum; $freq++) {
        ...
        if ($freq %2 == 0) {
            ...
            is_tolerance($magnitude, get_square_harmonic_amplitude($freq), "freq:$freq Amplitude of harmonic is with in tolerance");
        }
    }
}
